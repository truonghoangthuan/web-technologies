                ...
                <div class="col-md-12">
                    ...
                    <form name="frm" id="frm" action="/contacts/<?= $this->e($contact['id']) ?>" method="post" class="col-md-6 col-md-offset-3">
                        ...
                        <div class="form-group<?= isset($errors['name']) ? ' has-error' : '' ?>">
                            ...
                            <input type="text" name="name" class="form-control" maxlen="255" id="name" placeholder="Enter Name" value="<?= $this->e($contact['name']) ?>" />
                        ...
                        <div class="form-group<?= isset($errors['phone']) ? ' has-error' : '' ?>">
                            ...
                            <input type="text" name="phone" class="form-control" maxlen="255" id="phone" placeholder="Enter Phone" value="<?= $this->e($contact['phone']) ?>" />
                        ...
                        <div class="form-group<?= isset($errors['notes']) ? ' has-error' : '' ?>">
                            ...
                            <textarea name="notes" id="notes" class="form-control" placeholder="Enter notes (maximum character limit: 255)"><?= $this->e($contact['notes']) ?></textarea>
