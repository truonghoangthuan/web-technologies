...
Router::get('/api/v1/contacts', '\App\Controllers\ContactsApiController@search');
...
Router::get('/api/v1/contacts/all', '\App\Controllers\ContactsApiController@getAllContacts');
